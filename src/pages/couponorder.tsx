...
const CouponOrder: NextPage = (props) => {
            ...
            <Box sx={style}>
                ...
                <Box sx={{ backgroundColor:'white', display:'flex', alignItems:'center', maxWidth:365, minHeight:105, 
                    ...
                    <Box sx={{ display:'flex', flexDirection:'column', alignItems:'center', }}>
                        ...
                        <Typography sx={{ color:'#9945FF', fontSize:16, fontWeight:600, marginRight:2,
                            ...
                            <Typography sx={{ color:'black', fontSize:20, fontWeight:600 }}>
                                {(lattePrice + cookiePrice)*0.9} SOL
                            </Typography>
